...
# === LOGO + TITLE HEADER ===
col1, col2, col3, col4, col5 = st.columns([0.05, 0.002, 0.05, 0.01, 0.1])  # Tighter layout
...
with col5:
    st.markdown("""
        <h1 style='text-align: center-left; font-size: 72px; margin-top: 10px;'>Player Readiness</h1>
